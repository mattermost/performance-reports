# Performance Comparison `v11.10.1` vs `v11.11.0-rc2`

## Comments

- Nominal results, no significant performance regression:
  - **Unbounded test**: the unbounded test shows no significant difference in the number of supported users, with a \-0.09% delta that lies well within the \[-5%, +5%\] interval of usual variance.
  - **Bounded test**: the bounded test shows no significant difference in user-facing metrics overall. 
...
- [Bounded test](https://snapshots.raintank.io/dashboard/snapshot/8fi1DyAXqos4V5kEaYeTSzBfUFJlE5IS)
- [Unbounded test](https://snapshots.raintank.io/dashboard/snapshot/heUTrlcf9RjR4vVUOm3icStrp7Suqaim)

### Supported users in unbounded test

| v11.10.1 | v11.11.0-rc2 | Delta   |
|----------|--------------|---------|
| 18145    | 18129        | \-0.09% |
