...
- If anything, there is a slightly higher count of number of users for the new version: +5.66% for MySQL and +5.93% for PostgreSQL in the reported number of supported users. This number is slightly out of the usual variance we see of ±5%.
